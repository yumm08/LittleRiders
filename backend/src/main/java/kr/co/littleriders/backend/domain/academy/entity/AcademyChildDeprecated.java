...
@Getter
@DynamicUpdate
public class AcademyChildDeprecated {
    ...
    private AcademyChildDeprecated(Child child, Academy academy, AcademyFamily family, AcademyChildStatus status, CardType type) {
        this.child = child;
    ...
    public static AcademyChildDeprecated of(Child child, Academy academy, AcademyFamily family, AcademyChildStatus status, CardType type) {
        return new AcademyChildDeprecated(child, academy, family, status, type);
    }

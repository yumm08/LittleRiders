...
class FamilyHistoryControllerTest {
    ...
    class readBoardingList {
        ...
        void whenSuccess() throws Exception {
            ...
            // history 생성
            BoardDropHistory history = BoardDropHistory.of(academy, academyChildDeprecated, 37.50142, 127.0396, BoardDropHistoryStatus.BOARD);
            boardDropHistoryService.save(history);

            // history1 생성
            BoardDropHistory history1 = BoardDropHistory.of(academy, academyChildDeprecated, 37.5, 127.0396, BoardDropHistoryStatus.DROP);
            boardDropHistoryService.save(history1);

            // history2 생성
            BoardDropHistory history2 = BoardDropHistory.of(academy, academyChildDeprecated, 37.442, 127.0396, BoardDropHistoryStatus.BOARD);

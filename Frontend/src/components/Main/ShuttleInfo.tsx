        ...
        >
          ...
          <div className="h-full border-b-2">
            <div className="flex h-full flex-col items-center gap-2">
              ...
              <p className="text-lg">{selectedShuttle.licenseNumber}</p>
              <p className="text-sm">{selectedShuttle.type}</p>
            </div>
          </div>
          ...
          {driverInfo && (
            <div className="h-full border-b-2">
              <div className="flex h-full flex-col items-center gap-2">
                ...
                <p className="text-lg">{driverInfo.name} 기사님</p>
                <p className="text-sm">
                  {formatStringToPhoneNumber(driverInfo.phoneNumber)}
                </p>
              </div>
            </div>
          )}
          ...
          {teacherInfo && (
            <div className="h-full border-b-2">
              <div className="flex h-full flex-col items-center gap-2">
                ...
                <p className="text-lg">{teacherInfo.name} 선생님</p>
                <p className="text-sm">
                  {formatStringToPhoneNumber(teacherInfo.phoneNumber)}
                </p>
              </div>
            </div>
          )}
